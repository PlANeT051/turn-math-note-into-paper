...
For this author's introductions, establish the historical line of the problem before presenting a detailed definition block. The history must lead to the object and gap; it is not a chronological bibliography dump. Move routine graph conventions and full product definitions to preliminaries.
